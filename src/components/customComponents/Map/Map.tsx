...
<div className="bg-white h-full pb-0 lg:p-10 space-y-6">
            ...
            <div className="relative p-8 md:p-0 z-10 pt-8 text-black space-y-5">
  {/* Main Content Stack */}
  <div className="space-y-2">
    ...
    <p className={`text-lg lg:text-2xl text-red-400 text-center md:text-left md:block ${poppins.className}`}>
